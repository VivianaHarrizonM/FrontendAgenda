      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          >
            ...
            <div className="my-3">
              <label htmlFor="" className="uppercase font-bold">Sitio Web</label>
              <input 
                type="text" 
                className="border bg-gray-50 w-full p-2 mt-5 rounded-lg"  
                name="web"
            ...
            <div className="my-3">
              <label htmlFor="" className="uppercase font-bold"> Teléfono</label>
              <input 
                type="text" 
                className="border bg-gray-50 w-full p-2 mt-5 rounded-lg"  
                name="telefono"
            ...
            <div className="my-3">
              <label htmlFor="" className="uppercase font-bold">Email</label>
              <input 
                type="text" 
                className="border bg-gray-50 w-full p-2 mt-5 rounded-lg"  
                name="email"
